"""Run paper-aligned all-layers OVERSEE end-to-end demo.
...
def main() -> None:
    """Run the paper-aligned all-layers end-to-end demo and persist inspectable outputs."""

    load_powershell_env_file(PROJECT_ROOT / ".env")

    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    output_dir = PROJECT_ROOT / "outputs" / f"paper_aligned_all_layers_demo_{timestamp}"
    ...
    print("paper-aligned all-layers OVERSEE demo completed.")
    print()
    print(
        json.dumps(
            {
                "paper_aligned_all_layers_demo_completed": True,
