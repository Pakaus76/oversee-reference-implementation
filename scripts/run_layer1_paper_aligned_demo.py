"""Run paper-aligned OVERSEE Layer 1 demo."""
...
def main() -> None:
    ...
    output_dir = PROJECT_ROOT / "outputs" / f"paper_aligned_layer1_demo_{timestamp}"
    ...
    print("Paper-aligned Layer 1 demo completed.")
    print()
    print(
        json.dumps(
            {
