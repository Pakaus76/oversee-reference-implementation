"""Tests for the paper-aligned all-layers OVERSEE end-to-end demo."""
...
def test_all_layers_builds_governed_package_from_layers_1_to_4() -> None:
    """All-layers should build a governed package from the full prior flow."""

    flow = _build_all_layers_flow()
...
def test_all_layers_preserves_generative_comparison_metadata() -> None:
    """All-layers should preserve generative comparison and fallback metadata."""
...
def test_all_layers_outputs_avoid_old_bridge_terminology() -> None:
    """All-layers outputs should not expose old bridge terminology."""
