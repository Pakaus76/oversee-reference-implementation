...
- Scenario ID: `CHILLER-001`
- Title: Chiller energy efficiency degradation case
- Asset: `CHILLER-001`
- Asset type: `industrial_chiller`
- Failure mode: `energy_efficiency_degradation`
- Decision pattern: `energy_optimization_action`

## Layer 1 - Evidence package

- Case ID: `SCENARIO_CHILLER_001_ALERT-CHILLER-001-20260603`
...
- Recommended execution mode: `standard_planning`
- Intervention feasible: `True`
- Human review required: `True`
- Triggered rule count: `3`

## Layer 5 - Governed package

- Package ID: `governed_package_SCENARIO_CHILLER_001_ALERT-CHILLER-001-20260603`
