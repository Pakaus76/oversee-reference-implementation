...
- Scenario ID: `CONV-001`
- Title: Production-constrained conveyor case
- Asset: `CONV-001`
...
- Case ID: `SCENARIO_CONV_001_ALERT-CONV-001-20260603`
...
- Layer 2 ready: `True`
- Derived context: `{'technical_urgency': 'high', 'asset_escalation': 'required', 'operational_constraint': 'high', 'downtime_window': 'distant', 'intervention_feasible': True, 'recurrence_risk': 'high', 'human_review_required': True, 'layer2_decision_ready': True}`
...
- Package ID: `governed_package_SCENARIO_CONV_001_ALERT-CONV-001-20260603`
